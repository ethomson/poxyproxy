...
public class Options
{
	...
	/**
	 * The authentication type, when authentication is required.
	 */
	private volatile AuthenticationType authenticationType = AuthenticationType.Basic;
	...
	public String getProxyCredentials(String username)
	{
		synchronized (proxyCredentials)
		{
			return proxyCredentials.get(username);
		}
	}
